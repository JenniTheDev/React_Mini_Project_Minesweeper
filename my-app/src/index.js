            ...
            <div className="game">
                <div className="game-info">
                    <div className="instructions">
                        ...
                        <p> If you click on a square containing a bomb, you lose. If you manage to click all the squares (without clicking on any bombs) or flag all the mines, you win.</p>
                    ...
                    <button type = "button" onClick={this.handleGameStart}>Start</button>
